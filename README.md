...
- [ ] 랜덤 수 생성: 1부터 9까지의 서로 다른 수로 이루어진 3자리 수를 임의로 선택합니다.
  - [ ] 각 자리의 숫자가 중복될 수 없다.
  - [ ] 은 포함되지 않는다.
...
- [ ] 비교 로직
  ...
  - [ ] `낫싱`: 같은 수가 전혀 없는 경우
- [ ] 결과 출력
  - [ ] 계산된 볼과 스트라이크 개수를 출력합니다.
  - [ ] 하나도 맞지 않을 경우 `낫싱`을 출력합니다.
  - [ ] 스트라이크와 볼이 같이 있는 경우, 보통 볼을 먼저 출력하고 스트라이크를 나중에 출력하는 형식을 따릅니다.
...
- [ ] 숫자가 아닌 문자가 포함된 경우.
- [ ] 3자리가 아닌 경우 (2자리 이하 또는 4자리 이상)
- [ ] 중복된 숫자가 있는 경우 (예: 112)
- [ ] 1~9 범위를 벗어난 숫자(0)가 포함된 경우
